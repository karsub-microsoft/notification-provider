...
namespace NotificationService.UnitTests.Data.Repositories
{
    ...
    public class EmailNotificationRepositoryTestsBase
    {
        ...
        protected void SetupTestBase()
        {
            ...
            _ = this.EmailHistoryContainer
                .Setup(container => container.GetItemLinqQueryable<EmailNotificationItemCosmosDbEntity>(default, default, default, default))
            ...
            _ = this.MeetingHistoryContainer
                .Setup(container => container.GetItemLinqQueryable<MeetingNotificationItemCosmosDbEntity>(default, default, default, default))
