...
namespace NotificationService.UnitTests.Data.Repositories
{
    ...
    public class EmailNotificationRepositoryMeetingInviteTests : EmailNotificationRepositoryTestsBase
    {
        ...
        public void GetMeetingNotificationItemEntitiesTestValidInput()
        {
            ...
            Assert.AreEqual(result.Status.ToString(), "RanToCompletion");
            this.CosmosDBQueryClient.Verify(cdq => cdq.GetCosmosContainer(It.IsAny<string>(), MeetingHistoryContainerName), Times.Once);
            this.MeetingHistoryContainer.Verify(container => container.GetItemLinqQueryable<MeetingNotificationItemCosmosDbEntity>(default, default, default, default), Times.Once);
            Assert.Pass();
        }
        ...
        public async Task GetMeetingNotificationItemEntitiesBetweenDatesTestsCosmosDb()
        {
            ...
            this.CosmosDBQueryClient.Verify(cdq => cdq.GetCosmosContainer(It.IsAny<string>(), MeetingHistoryContainerName), Times.Once);
            this.MeetingHistoryContainer.Verify(container => container.GetItemLinqQueryable<MeetingNotificationItemCosmosDbEntity>(default, default, default, default), Times.Exactly(3));
            Assert.Pass();
